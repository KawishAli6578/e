 ...
 *
 */
import logoIcon from "./kumoship_logo_icon.png";
import logoIconColored from "./dark_logo_icon.png";
...
export default function LogoIcon() {
  ...
  return (
     ...
     */
    <img
      src={theme.palette.mode === ThemeMode.DARK ? logoIcon : logoIconColored}
      alt="Kumoship"
      width="100%"
      height="100%"
      style={{
