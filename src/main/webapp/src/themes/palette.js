...
export default function Palette(mode, presetColor, customColor) {
...
console.log(presetColor,"presetColor-in")
  const paletteColor = ThemeOption(colors, presetColor, mode, customColor);
