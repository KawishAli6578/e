// project import
import CustomThemeColor from './custom';
import Default from './default';
import KumoshipTheme from './kumoship';
...
export default function Theme(colors, presetColor, mode, customColor) {
  switch (presetColor) {
    case 'theme1':
    ...
    case 'kumoship':
      return KumoshipTheme(colors, mode);
    case 'custom':
      return CustomThemeColor(colors, mode, customColor);
    default:
