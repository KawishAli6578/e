...
export default function KumoshipTheme(colors, mode) {
  const { grey } = colors;
  const greyColors = {
    0: grey[0],
    50: grey[1],
  ...
  let primaryColors = ['#f0fcff', '#f0fbff', '#cceffc', '#9cd5f0', '#6fbae3', '#48a0d7', '#317bb0', '#205a8a', '#123c63', '#0a233d'];
  ...
  if (mode === ThemeMode.DARK) {
    primaryColors = ['#f0fdff', '#f0fdff', '#f0fcff', '#f0fcff', '#f0fbff', '#cceffc', '#a3c7d6', '#7d9fb0', '#5b798a', '#415663'];
