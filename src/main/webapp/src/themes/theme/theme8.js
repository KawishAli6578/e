...
export default function Theme8(colors, mode) {
  ...
  return {
    primary: {
      ...
      100: primaryColors[3],
      200: primaryColors[4],
      light: primaryColors[5],
      400: primaryColors[6],
      main: primaryColors[7],
      dark: primaryColors[8],
      700: primaryColors[9],
      800: primaryColors[10],
      darker: primaryColors[11],
      900: primaryColors[12],
      contrastText,
      gradient: `linear-gradient(40deg, ${primaryColors[1]}, ${primaryColors[7]})`,
    },
    secondary: {
